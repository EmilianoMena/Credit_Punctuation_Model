...
customer_variables = ['Name','Annual_Income','Monthly_Inhand_Salary','Interest_Rate','Credit_Mix','Credit_History_Age']
...
outliers_variables = ['Interest_Rate','Num_of_Delayed_Payment','Num_Credit_Inquiries']
for var in outliers_variables: # Replace the outliers
   df2[var] = f.outliers_replace(df2,var,1)
...
model_variables = ['Delay_from_due_date','Num_of_Delayed_Payment',#'Total_EMI_per_month', # Payment history 30%
                   ...
                   'Num_Credit_Inquiries'] # New credit 10% # Credit utilization 10%
scores = [[200,150,100,75,50,25],[150,120,90,60,30],[300,275,250,150,75,50],[15,30,45,60,85,100],[150,75,25],[100,85,60,45,30]]
ranges = [[3,10,30,60,90],[1,7,13,19],[500,1000,1500,2000,2500],[24,48,72,96,120],['Good','Standard'],[2,6,10,14]]
